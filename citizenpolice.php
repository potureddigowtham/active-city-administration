...
<h3>&nbsp;&nbsp;&nbsp;Active City Administration</h3>

<div class="a">
  <form name=report method=post action="<?php echo $_SERVER['PHP_SELF']; ?>">
...
<?php
  if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO police_report values('$name','$msg')";
