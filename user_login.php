...
<div class="container"> 
  <!-- Navigation -->
  <header> <a href="">
    <h4 class="logo">CITIZEN_LOGIN</h4>
    </a>
    <nav>
      <ul>
  ...
  <div class="txt"><center><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ----Login To Report----</h3></center></div>
...
session_start();
  if(isset($_POST['submit'])){
    ...
    $sql="SELECT password from usr_login where username='$name'";
...
echo "<script type='text/javascript'>window.location.href='reportpage.html';</script>";
    }
     else {
       $flag=2;
